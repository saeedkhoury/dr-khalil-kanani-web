...
- A Hebrew/Arabic display face to differentiate further, with native review
- Educational content built on the reg. 4 exemption — the one content strategy
  the advertising regulations actively permit, and the strongest available
  SEO play
- Git-based CMS (Keystatic), only if the owner actually asks twice
- WhatsApp Business API for lead notification

## Explicitly not planned

Reviews · before/after gallery · pricing pages · real-time booking.
The first three are prohibited, not deferred. See ADR 0005 and 0006.
