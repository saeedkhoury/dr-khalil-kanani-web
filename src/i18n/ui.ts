...
export const ui = {
  he: {
    ...
    'form.handoffNote': 'הפרטים אינם נשמרים באתר — הם נשלחים ישירות לתיבת הדואר של המרפאה.',
  ...
  ar: {
    ...
    'form.handoffNote': 'لا يحفظ الموقع تفاصيلكم — تُرسَل مباشرة إلى بريد العيادة.',
  ...
  en: {
    ...
    'form.handoffNote': 'This site does not store your details — they are sent straight to the clinic inbox.',
