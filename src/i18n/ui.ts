...
export const ui = {
  he: {
    ...
    'gallery.workIntro': 'מבחר תמונות טיפולים שפורסמו בעמוד האינסטגרם של המרפאה. לכל תמונה מצורף קישור לפרסום המקורי.',
    'gallery.source': 'לפרסום המקורי באינסטגרם',
    'gallery.profile': 'לעמוד האינסטגרם של המרפאה',
  ...
  ar: {
    ...
    'gallery.workIntro': 'مجموعة من صور العلاجات المنشورة على صفحة العيادة في إنستغرام. ترتبط كل صورة بالمنشور الأصلي.',
    'gallery.source': 'المنشور الأصلي على إنستغرام',
    'gallery.profile': 'صفحة العيادة على إنستغرام',
  ...
  en: {
    ...
    'gallery.workIntro': 'Selected treatment photographs published on the clinic’s Instagram. Each image links to its original post.',
    'gallery.source': 'View the original Instagram post',
    'gallery.profile': 'Visit the clinic on Instagram',
